...
test.describe('Form Data Persistence', () => {
  ...
  test('Step 3: Education fields persist after blur and refresh', async ({ browser }) => {
  ...
  test('Step 4: Career fields persist after blur and refresh', async ({ browser }) => {
    const context = await browser.newContext();
    const page = await context.newPage();
  ...
  test('Step 5: Family fields persist after blur and refresh', async ({ browser }) => {
    const context = await browser.newContext();
    const page = await context.newPage();
  ...
  test('Step 6: Language fields persist after blur and refresh', async ({ browser }) => {
    const context = await browser.newContext();
    const page = await context.newPage();
  ...
  test('Step 7: Country Selection fields persist after blur and refresh', async ({ browser }) => {
    const context = await browser.newContext();
    const page = await context.newPage();
  ...
  test('All steps: Complete form persists after full refresh', async ({ browser }) => {
    const context = await browser.newContext();
    const page = await context.newPage();
