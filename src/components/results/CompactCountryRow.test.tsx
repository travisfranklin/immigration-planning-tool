...
const mockScore: ViabilityScore = {
  ...
  recommendedProgram: {
    ...
    programType: 'work',
    eligibilityScore: 62,
    componentScores: { career: 70, financial: 60, education: 65, language: 50, family: 55 },
    overallScore: 62,
  ...
  alternativePrograms: [
    {
      ...
      eligibilityScore: 45,
      componentScores: { career: 50, financial: 40, education: 45, language: 40, family: 35 },
      overallScore: 45,
      matchReason: 'Alternative for entrepreneurs',
      alignsWithUserPath: false,
      alignsWithTimeline: true,
