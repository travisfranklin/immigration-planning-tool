...
flowchart TD
 ...
 description: 'Submit EU Blue Card application to Croatian Ministry of Interior',
 estimatedDuration: '1 week',
 documents: ['All documents', 'Application fee'],
 notes: ['Apply at Croatian embassy/consulate or online', 'Application fee varies by location'],
 },
 {
 id: 'processing',
 title: 'Processing',
 description: 'Wait for Ministry of Interior to process application',
 estimatedDuration: '30-60 days',
 documents: [],
 notes: ['Processing typically takes 30-60 days', 'May be contacted for additional documents', 'Track status online'],
 },
 {
 id: 'Card',
 title: 'Receive EU Blue Card',
 description: 'Collect your approved EU Blue Card (valid for 2 years)',
 estimatedDuration: '1-2 weeks',
 documents: ['Approval letter', 'Passport', 'EU Blue Card'],
 notes: ['Initial card valid for 2 years', 'Renewable', 'PR in 5 years, citizenship in 8 years', 'Allows travel in Schengen area'],
 },
 {
 id: 'registration',
 title: 'Register in Croatia',
 description: 'Complete registration at local police station and obtain residence permit',
 estimatedDuration: '1-2 weeks',
 documents: ['EU Blue Card', 'Passport', 'Employment contract', 'Proof of accommodation'],
 notes: ['Register within 3 days of arrival', 'Obtain OIB (personal identification number)', 'Register at local police station', 'Open bank account'],
 },
 ],
 },
 'hr_digital_nomad': {
...
flowchart TD
 ...
 id: 'Submit',
 title: 'Submit Application',
 description: 'Submit digital nomad visa application to Croatian embassy/consulate',
 estimatedDuration: '1 week',
 documents: ['All gathered documents', 'Application form', 'Application fee'],
 notes: ['Apply at Croatian embassy/consulate in home country', 'Can also apply online via e-Consulate system', 'Application fee typically EUR 60-80'],
 },
 {
 id: 'Process',
 title: 'Processing',
 description: 'Wait for embassy to process digital nomad visa application',
 estimatedDuration: '30 days',
 documents: [],
 notes: ['Fast processing (typically 30 days)', 'One of the fastest digital nomad visas in Europe', 'May be contacted for additional documents'],
 },
 {
 id: 'visa',
 title: 'Receive Digital Nomad Visa',
 description: 'Collect your approved digital nomad visa (valid for 1 year)',
 estimatedDuration: '1 week',
 documents: ['Approval letter', 'Passport with visa', 'All original documents'],
 notes: ['Valid for 1 year', 'Renewable for 1 more year', 'Can convert to other visa for PR/citizenship path', 'No tax on foreign income'],
 },
 {
 id: 'Travel',
 title: 'Travel to Croatia',
 description: 'Enter Croatia and start working remotely from paradise',
 estimatedDuration: '1 week',
 documents: ['Passport with digital nomad visa', 'Proof of accommodation', 'Health insurance'],
 notes: ['Register at local police within 3 days of arrival', 'Obtain OIB (personal identification number)', 'Open bank account if needed', 'Enjoy the Adriatic coastline!'],
 },
 ],
 },
