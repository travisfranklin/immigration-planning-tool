...
flowchart TD
  ...
  job-offer --> salary{Salary >= EUR 33,240/year?}
  ...
  steps: [
    {
      ...
      options: {
        salaryThreshold: 33240,
        additionalNotes: ['Prague is major tech hub', 'English widely spoken in tech companies', '1.5x average gross annual salary'],
      },
    },
    {
