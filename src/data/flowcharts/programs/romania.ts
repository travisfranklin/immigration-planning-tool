/**
 * Romania Immigration Programs
 *
 * Built using the template-based composition system.
 * Romania has 5 main programs:
 * 1. EU Blue Card
 * 2. Startup Visa
 * 3. Work Permit
 * 4. Self-Employment
...
flowchart TD
  ...
  job-offer --> salary{"Salary >= RON 10,000/month?"}
  ...
  steps: [
    {
      ...
      options: {
        salaryThreshold: 120000,
        additionalNotes: ['Growing tech hub', 'Low cost of living', 'EU member state'],
      },
    },
    {
      ...
      options: {
        ...
        additionalNotes: ['All documents must be apostilled', 'Translations to Romanian required'],
      },
    },
    ...
    { template: COMMON_STEP_IDS.TRAVEL, options: { visaType: 'EU Blue Card' } },
    {
      ...
      options: {
        registrationAuthority: 'General Inspectorate for Immigration',
        additionalNotes: ['Register within 30 days of arrival', 'Get residence permit card'],
      },
    },
  ],
});
  ...
  steps: [
    {
      ...
      notes: ['Focus on tech or innovation sectors', 'Bucharest has growing startup ecosystem'],
    },
    {
      id: 'business-plan',
      ...
      notes: ['Plan must be in English or Romanian', 'Include realistic financial forecasts'],
    },
    {
      template: COMMON_STEP_IDS.GATHER_DOCUMENTS,
      options: {
    ...
    { template: COMMON_STEP_IDS.TRAVEL, options: { visaType: 'Startup Visa' } },
    {
      ...
      options: {
        registrationAuthority: 'General Inspectorate for Immigration',
        additionalNotes: ['Register within 30 days of arrival', 'Register business with Trade Register'],
      },
    },
  ],
});
  ...
  steps: [
    {
      ...
      options: {
        ...
        additionalNotes: ['Growing tech hub', 'Low cost of living', 'Employer must prove no suitable Romanian/EU candidate'],
      },
    },
    {
      template: COMMON_STEP_IDS.GATHER_DOCUMENTS,
...
flowchart TD
  ...
  steps: [
    ...
    { template: COMMON_STEP_IDS.PROCESSING, options: { processingTime: '30-60 days' } },
    {
      ...
      estimatedDuration: '1-2 weeks',
      documents: ['Passport'],
      notes: ['Visa valid for 90 days', 'Must enter Romania and apply for residence permit'],
    },
    { template: COMMON_STEP_IDS.TRAVEL, options: { visaType: 'family reunification visa' } },
    {
      ...
      options: {
        registrationAuthority: 'General Inspectorate for Immigration',
        additionalNotes: ['Register within 30 days of arrival', 'Apply for residence permit'],
      },
    },
  ],
});
...
/**
 * Export all Romania flowcharts as a record for compatibility with existing system
 */
/**
...
flowchart TD
  ...
  remote-work -->|Yes| income{Income >= EUR 3,800/month?}
  ...
  decision -->|Rejected| End2([Process Ended])
  visa -->travel[Travel to Romania]
  travel -->registration[Register with Immigration]
  registration --> Success([Process Complete])`,
  steps: [
    {
      id: 'remote-work',
      title: 'Verify Remote Work Status',
      description: 'Confirm remote employment or freelance work for non-Romanian company',
      estimatedDuration: '1 week',
      documents: ['Employment contract or freelance contracts'],
      notes: ['Must work for company outside Romania', 'Very affordable cost of living'],
    },
    {
      id: 'income',
      title: 'Verify Income Requirement',
      description: 'Prove monthly income of at least EUR 3,800',
      estimatedDuration: 'N/A',
      documents: ['Bank statements (3-6 months)', 'Employment contract or invoices'],
      isConditional: true,
      condition: 'Monthly income >= EUR 3,800',
      notes: ['Income from remote work outside Romania', 'High threshold but low cost of living'],
    },
    {
      template: COMMON_STEP_IDS.GATHER_DOCUMENTS,
      options: {
        ...
        additionalNotes: ['Documents must be apostilled', 'Romanian or English accepted'],
      },
    },
    { template: COMMON_STEP_IDS.SUBMIT_APPLICATION, options: { applicationFee: 120 } },
    { template: COMMON_STEP_IDS.PROCESSING, options: { processingTime: '30-60 days' } },
    {
      ...
      estimatedDuration: '1-2 weeks',
      documents: ['Passport'],
      notes: ['Valid for 1 year', 'Renewable', 'Growing digital nomad community in Bucharest and Cluj'],
    },
    { template: COMMON_STEP_IDS.TRAVEL, options: { visaType: 'Digital Nomad Visa' } },
    {
      ...
      options: {
        registrationAuthority: 'General Inspectorate for Immigration',
        additionalNotes: ['Register within 30 days', 'Get residence permit card'],
      },
    },
  ],
});
