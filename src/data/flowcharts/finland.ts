...
flowchart TD
 ...
 description: 'Collect your approved residence permit card',
 estimatedDuration: '1-2 weeks',
 documents: [
 'Approval letter from Migri',
 'Passport',
 'Residence permit card',
 ],
 notes: [
 'Permit card sent to Finnish address or embassy',
 'Valid for up to 4 years initially',
 'Renewable if employment continues',
 'Allows work only for the specified employer',
 'Can be extended or converted to continuous permit after 4 years',
 ],
 },
 {
 id: 'Appeal',
 title: 'Consider Appeal',
 description: 'If rejected, consider appealing the decision to Administrative Court',
 ...
 'Submit to Administrative Court (Hallinto-oikeus)',
