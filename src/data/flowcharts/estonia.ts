...
flowchart TD
 ...
 documents: ['E-Residency application', 'Fee ( EUR 100- EUR 200)', 'ID documents', 'Passport copy'],
 notes: ['UNIQUE E-Residency program!', 'Run Estonian company remotely', 'E-government services', 'Digital identity for non-residents'],
 },
 {
 id: 'Card',
 ...
 notes: ['Pick up at Estonian embassy or in Estonia', 'Digital ID card with chip', 'Enables digital signatures', 'Access to e-government services'],
 },
 {
 id: 'company',
 ...
 {
 id: 'Operate',
 title: 'Operate Business Remotely',
 description: 'Run your Estonian company from anywhere in the world',
 estimatedDuration: 'Ongoing',
 documents: ['E-Residency card for digital signatures', 'Estonian bank account', 'Accounting software'],
 ...
 estimatedDuration: '1 week',
 documents: ['Company documents', 'Proof of funds ( EUR 5,000)', 'Business plan', 'Proof of accommodation'],
 notes: ['Optional - only if you want to relocate', 'Can continue operating remotely instead', 'Most tech-forward country!'],
 isConditional: true,
 condition: 'Only if you want to relocate to Estonia',
 },
 {
 id: 'Docs',
 title: 'Gather Documents for Residence Permit',
 description: 'Collect all required documents for business residence permit',
 estimatedDuration: '2-3 weeks',
 documents: [
 ...
 notes: ['All documents must be apostilled', 'Certified translations required for non-English documents'],
 },
 {
 id: 'Submit',
 title: 'Submit Residence Permit Application',
 description: 'Submit application to Estonian Police and Border Guard Board',
 estimatedDuration: '1 week',
 documents: ['All gathered documents', 'Application form', 'Application fee ( EUR 160)'],
 notes: ['Apply at Estonian embassy/consulate or in Estonia', 'Book appointment in advance', 'Bring original documents'],
 },
 {
 id: 'Process',
 title: 'Processing',
 description: 'Wait for Police and Border Guard Board to process application',
 estimatedDuration: '30-90 days',
 documents: [],
 notes: ['Processing time: 30-90 days', 'May be contacted for additional documents', 'Can track status online'],
 },
 {
 id: 'Permit',
 title: 'Receive Residence Permit',
 description: 'Collect your approved residence permit (valid for 1 year)',
 estimatedDuration: '1-2 weeks',
 documents: ['Approval letter', 'Passport', 'Residence permit card'],
 notes: ['Valid for 1 year initially', 'Renewable for up to 5 years', 'PR in 5 years, citizenship in 8 years', 'Most tech-forward country in the world!'],
 },
 ],
 },
