 ...
 reactFlowData: {
      "nodes": [
        ...
        },
        {
          ...
          "data": {
            "label": "Submit Application to<br/>Polish Consulate or in Poland",
            "stepId": "application",
            "nodeType": "process"
          }
        },
        ...
        },
        {
          ...
          "data": {
            "label": "Receive EU Blue Card<br/>3-Year Permit",
            "stepId": "card",
            "nodeType": "process"
          }
        },
        ...
        },
        {
          ...
          "data": {
            "label": "Register at Local<br/>Voivodeship Office",
            "stepId": "register",
            "nodeType": "process"
          }
        },
...
flowchart TD
 ...
 apply-to-accelerator --> program-acceptance{Accepted by<br/>Accelerator?}
 ...
 decision -->|Rejected| consider-appeal[Consider Appeal]
 receive-visa --> travel[Travel to Poland]
 travel --> register-business[Register Business and<br/>at Voivodeship Office]
 ...
 reactFlowData: {
      "nodes": [
        ...
        },
        {
          ...
          "data": {
            "label": "Apply to Polish<br/>Startup Accelerator",
            "stepId": "accelerator",
            "nodeType": "process"
          }
        },
        ...
        },
        {
          ...
          "data": {
            "label": "Accepted by<br/>Accelerator?",
            "stepId": "acceptance",
            "nodeType": "decision"
          }
        },
        ...
        },
        {
          ...
          "data": {
            "label": "Register Business and<br/>at Voivodeship Office",
            "stepId": "business",
            "nodeType": "process"
          }
        },
 ...
 reactFlowData: {
      "nodes": [
        ...
        },
        {
          ...
          "data": {
            "label": "Salary >= PLN 4,000/month<br/>EUR 900?",
            "stepId": "salary",
            "nodeType": "decision"
          }
        },
        ...
        },
        {
          ...
          "data": {
            "label": "Submit Application<br/>to Voivodeship Office",
            "stepId": "application",
            "nodeType": "process"
          }
        },
        ...
        },
        {
          ...
          "data": {
            "label": "Register at<br/>Voivodeship Office",
            "stepId": "register",
            "nodeType": "process"
          }
        },
