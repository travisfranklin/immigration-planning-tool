...
flowchart TD
 ...
 reactFlowData: {
      nodes: [
        ...
        },
        {
          ...
          data: {
            label: "Salary >= DKK 465,000<br/>or Recent Grad >= DKK 375,000?",
            stepId: "CheckSalary",
            nodeType: "decision"
          }
        },
        {
          ...
          data: {
            label: "Employer on<br/>Fast-Track List?",
            stepId: "CheckCompany",
            nodeType: "decision"
          }
        },
        ...
        },
        {
          ...
          data: {
            label: "Submit Application Online",
            stepId: "application",
            nodeType: "process"
          }
        },
        {
          ...
          data: {
            label: "Fast-Track Processing<br/><=30 Days",
            stepId: "processing",
            nodeType: "process"
          }
        },
        ...
        },
        {
          ...
          data: {
            label: "Register at SIRI<br/>Get CPR Number",
            stepId: "registration",
            nodeType: "process"
          }
        },
 ...
 description: 'Collect your approved residence and work permit card',
 estimatedDuration: '1-2 weeks',
 documents: [
 'Approval letter from SIRI',
 'Residence permit card (sent by mail)',
 'Passport',
 ],
 notes: [
 'Permit card sent to your address by mail',
 'Valid for duration of employment contract (up to 4 years)',
 'Renewable if employment continues',
 'Allows work only for the specified employer',
 'Can change employers with new Fast-Track application',
 'Family members can apply for family reunification immediately',
 ],
 },
 {
 id: 'Appeal',
 title: 'Consider Appeal',
 description: 'If rejected, consider appealing the decision to Refugee Appeals Board',
 ...
 notes: [
 'Appeal must be filed within 8 weeks of decision',
 'Submit to Refugee Appeals Board (Flygtningenævnet)',
 ...
 'Rejection rare for Fast-Track (~5% rejection rate)',
 ],
 },
 {
 id: 'travel-register',
 title: 'Travel to Denmark',
 description: 'Move to Denmark with your residence permit',
 estimatedDuration: '1 week',
 documents: [
 ...
 notes: [
 'Must enter Denmark before permit expiration',
 ...
 description: 'Complete registration and obtain CPR number (Civil Registration Number)',
 ...
 'Receive CPR number - essential for everything in Denmark',
 ...
 'Register with municipality (Kommune)',
 ...
 reactFlowData: {
      nodes: [
        ...
        },
        {
          ...
          data: {
            label: "Salary >=<br/>DKK 465,000/year?",
            stepId: "CheckSalary",
            nodeType: "decision"
          }
        },
        ...
        },
        {
          ...
          data: {
            label: "Standard Processing<br/>60-90 Days",
            stepId: "Processing",
            nodeType: "process"
          }
        },
  ...
  reactFlowData: {
      nodes: [
        ...
        },
        {
          ...
          data: {
            label: "Have DKK 50,000<br/>minimum savings?",
            stepId: "funds",
            nodeType: "decision"
          }
        },
        ...
        },
        {
          ...
          data: {
            label: "Expert Panel Review<br/>30-60 Days",
            stepId: "review",
            nodeType: "process"
          }
        },
        ...
        },
        {
          ...
          data: {
            label: "Submit Visa Application<br/>to SIRI",
            stepId: "visa",
            nodeType: "process"
          }
        },
        ...
        },
        {
          ...
          data: {
            label: "Register Business<br/>and Get CPR Number",
            stepId: "business",
            nodeType: "process"
          }
        },
 ...
 reactFlowData: {
      nodes: [
        ...
        },
        {
          ...
          data: {
            label: "Salary >= DKK 465,000/year<br/>EUR 62,400?",
            stepId: "salary",
            nodeType: "decision"
          }
        },
        {
          ...
          data: {
            label: "Bachelor's Degree<br/>or Higher?",
            stepId: "education",
            nodeType: "decision"
          }
        },
        ...
        },
        {
          ...
          data: {
            label: "Submit Application<br/>to SIRI",
            stepId: "visa",
            nodeType: "process"
          }
        },
        {
          ...
          data: {
            label: "Fast-Track Processing<br/>30-60 Days",
            stepId: "processing",
            nodeType: "process"
          }
        },
